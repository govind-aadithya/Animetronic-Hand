...
def send_srv(mapped):
    #try:
	if ser.isOpen():
	    # Write the commands in this format = servo1,servo2,servo3,servo4,servo5\n
	    data = str(mapped[0][0]) + ',' + str(mapped[1][0]) + ',' + str(mapped[2][0]) + ',' + str(mapped[3][0]) + ',' + str(mapped[4][0]) + '\n'    # Ouput from media pipe
